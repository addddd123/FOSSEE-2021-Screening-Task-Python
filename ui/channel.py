...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(373, 412)
        Dialog.setStyleSheet("background-color: rgb(170, 255, 255);")
        self.formLayoutWidget = QtWidgets.QWidget(Dialog)
        self.formLayoutWidget.setGeometry(QtCore.QRect(20, 40, 171, 331))
...
"font: 75 12pt \"MS Shell Dlg 2\";")
        ...
        self.channel_TextLabel = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.channel_TextLabel.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.channel_TextLabel.setObjectName("channel_TextLabel")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.channel_TextLabel)
        self.label_5 = QtWidgets.QLabel(self.formLayoutWidget_2)
        self.label_5.setObjectName("label_5")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_5)
        self.channel_push_clear = QtWidgets.QPushButton(Dialog)
        self.channel_push_clear.setGeometry(QtCore.QRect(50, 380, 116, 23))
        self.channel_push_clear.setStyleSheet("background-color: rgb(107, 107, 107);\n"
"background-color: rgb(255, 0, 0);")
        self.channel_push_clear.setObjectName("channel_push_clear")
        self.channel_push_submit = QtWidgets.QPushButton(Dialog)
        self.channel_push_submit.setGeometry(QtCore.QRect(230, 380, 116, 23))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_37.setText(_translate("Dialog", "Enter Channel details"))
        ...
        self.channel_push_clear.setText(_translate("Dialog", "Clear"))
